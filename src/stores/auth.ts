...
import type { User, AuthResponse, LoginCredentials, RegisterCredentials } from '@/types/api';
...
export const useAuthStore = defineStore('auth', {
    ...
    actions: {
        ...
        async register(formData: RegisterCredentials) {
            ...
            try {
                ...
                const response = await axios.post<AuthResponse>('/register', { ...formData, lang });
        ...
        async login(formData: LoginCredentials) {
            const loadingStore = useLoadingStore();
            this.errors = {};
            loadingStore.start();
